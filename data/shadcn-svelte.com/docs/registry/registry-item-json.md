...
### [name](registry-item-json.md#name)
...
### [title](registry-item-json.md#title)
...
### [description](registry-item-json.md#description)
...
### [type](registry-item-json.md#type)
...
### [author](registry-item-json.md#author)
...
### [dependencies](registry-item-json.md#dependencies)
...
### [registryDependencies](registry-item-json.md#registrydependencies)

Defines other registry items that this item depends on.

Each entry may be one of the following:

#### [shadcn-svelte Registry Item](registry-item-json.md#shadcn-svelte-registry-item)
...
#### [Remote URL](registry-item-json.md#remote-url)
...
#### [Local alias (when building with the CLI)](registry-item-json.md#local-alias-when-building-with-the-cli)
...
#### [Relative Path](registry-item-json.md#relative-path)
...
### [files](registry-item-json.md#files)
...
#### [path](registry-item-json.md#path)
...
#### [type](registry-item-json.md#type-1)

The `type` property is used to specify the type of the file. See the [type](registry-item-json.md#type) section for more information.

#### [target](registry-item-json.md#target)
...
### [cssVars](registry-item-json.md#cssvars)
...
### [docs](registry-item-json.md#docs)
...
### [categories](registry-item-json.md#categories)
...
### [meta](registry-item-json.md#meta)
