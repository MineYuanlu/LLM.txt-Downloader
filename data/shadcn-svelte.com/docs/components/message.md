...
## [Installation](message.md#installation)
...
**Note:** `Message` owns the row layoutavatar, alignment, header, and footer. Render the visible message surface inside it with [`Bubble`](bubble).

## [Composition](message.md#composition)
...
## [Header and Footer](message.md#header-and-footer)
...
## [Accessibility](message.md#accessibility) `Message` is a presentational layout wrapper. Accessibility comes from the content you place inside it.

### [Label icon-only actions](message.md#label-icon-only-actions)
...
### [Status updates](message.md#status-updates)

For in-progress messages, use a [`Marker`](marker) with `role="status"` so assistive tech announces the update as it appears.
...
## [API Reference](message.md#api-reference)
...
| `class` | `string`           | -                | Additional classes to apply to the row. | ### [Message.Group](message.md#messagegroup)

Groups consecutive messages from the same sender.

| Prop                   | Type            | Default | Description                                                   |
| ---------------------------------------------------- | --------------------------------------------- | ------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| `class` | `string` | -       | Additional classes to apply to the group root. | ### [Message.Avatar](message.md#messageavatar)
...
| Prop                   | Type            | Default | Description                                                    |
| ---------------------------------------------------- | --------------------------------------------- | ------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| `class` | `string` | -       | Additional classes to apply to the avatar slot. | ### [Message.Content](message.md#messagecontent)

Wraps the header, message surface, and footer.

| Prop                   | Type            | Default | Description                                                     |
| ---------------------------------------------------- | --------------------------------------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| `class` | `string` | -       | Additional classes to apply to the content slot. | ### [Message.Header](message.md#messageheader)

Displays content above the message, such as a sender name. Stays aligned to the start regardless of `align`.

| Prop                   | Type            | Default | Description                                               |
| ---------------------------------------------------- | --------------------------------------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| `class` | `string` | -       | Additional classes to apply to the header. | ### [Message.Footer](message.md#messagefooter)
