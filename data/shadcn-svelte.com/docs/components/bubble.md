...
For full-featured chat interfaces, use the [`Message`](message) component. `Bubble` is intentionally scoped to the bubble surface. Place avatars, names, timestamps, metadata, and message-level actions in [`Message`](message).

## [Installation](bubble.md#installation)
...
## [Composition](bubble.md#composition)
...
## [Bubble Group](bubble.md#bubble-group)
...
## [Links and Buttons](bubble.md#links-and-buttons)
...
## [Show More / Collapsible](bubble.md#show-more--collapsible)

Long bubble content can be composed with [`Collapsible`](collapsible) to allow for a show more or show less interaction. Use the `Collapsible.Trigger` component to trigger the collapsible content.
...
## [Tooltip](bubble.md#tooltip)

Wrap a bubble in a [`Tooltip`](tooltip) to reveal metadata on hover, such as when a message was read.
...
## [Popover](bubble.md#popover)

Pair a bubble with a [`Popover`](popover) to surface more information on demand, such as the full error message for a failed action.
...
## [Accessibility](bubble.md#accessibility) `Bubble` renders the presentational message surface. Keep conversation-level semantics on the surrounding container and follow the guidelines below.

### [Labeling Reactions](bubble.md#labeling-reactions)
...
### [Interactive Bubbles](bubble.md#interactive-bubbles)
...
### [Meaning Beyond Color](bubble.md#meaning-beyond-color)
...
## [API Reference](bubble.md#api-reference)
...
| `class`   | `string`                                                                                   | -                  | Additional classes to apply to the root element. | ### [Bubble.Content](bubble.md#bubblecontent)
...
| `class` | `string`  | -       | Additional classes to apply to the content element. | ### [Bubble.Reactions](bubble.md#bubblereactions)
...
| `class` | `string`            | -                 | Additional classes to apply to the reaction row. | ### [Bubble.Group](bubble.md#bubblegroup)
