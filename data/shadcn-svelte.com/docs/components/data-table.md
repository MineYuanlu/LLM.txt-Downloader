...
- [Set up Table Features](data-table.md#set-up-table-features)  
...
### [Pagination is already enabled](data-table.md#pagination-is-already-enabled)
...
### [Change the page size](data-table.md#change-the-page-size)
...
### [Add the search input](data-table.md#add-the-search-input)
...
### [Add the column toggle dropdown](data-table.md#add-the-column-toggle-dropdown)
...
### [Manage the selection state externally](data-table.md#manage-the-selection-state-externally)
