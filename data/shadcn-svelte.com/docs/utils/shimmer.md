...
## [Installation](shimmer.md#installation)
...
## [With Marker](shimmer.md#with-marker)
...
## [Reverse](shimmer.md#reverse)

Use `shimmer-reverse` to sweep the highlight in the opposite direction. In RTL layouts the sweep already follows the reading direction. See [RTL](shimmer.md#rtl).

```svelte
<p class="shimmer shimmer-reverse">Generating response&hellip;</p>
```

## [Play Once](shimmer.md#play-once)
...
## [Disabling the Shimmer](shimmer.md#disabling-the-shimmer)
...
## [Reduced Motion](shimmer.md#reduced-motion)
